...
namespace _LineWorker
{
    public class CharacterScroller : MonoBehaviour
    {
        ...
        public ProducingMachine producingMachine;
        ...
        void Start()
        {
            ...
            for (int i = 0; i < CharacterManager.Instance.characters.Length; i++)
            {
                ...
                if(character.transform.childCount > 0){
                    for (int j = 0; j < character.transform.childCount; j++)
                    {
        ...
        public void SelectCharacter()
        {
            ...
            producingMachine.InitProductPool(CharacterManager.Instance.CurrentCharacterIndex);
