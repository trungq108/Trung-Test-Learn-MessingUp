...
namespace ArcadeBridge.ArcadeIdleEngine.OdinSerializer
{
    using ArcadeBridge.ArcadeIdleEngine.OdinSerializer.Utilities;
    using ArcadeBridge.ArcadeIdleEngine.OdinSerializer.Utilities.Unsafe;
    using System;
